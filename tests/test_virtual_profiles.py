...
from mcpm.core.schema import STDIOServerConfig, ProfileMetadata
...
def test_virtual_profile_creation(profile_manager):
    ...
    assert profile_manager.new_profile("test-profile") == True
    ...
    assert profile_manager.new_profile("test-profile") == False
...
def test_adding_server_to_virtual_profile(profile_manager, global_config):
    ...
    assert profile_manager.set_profile("web-dev", server_config) == True
...
def test_profile_metadata(profile_manager):
    ...
    assert profile_manager.update_profile_metadata(metadata) == True
...
def test_profile_deletion(profile_manager, global_config):
    ...
    # Delete profile
    assert profile_manager.delete_profile("temp-profile") == True
